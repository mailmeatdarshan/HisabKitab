  ...
  return (
    <div className="landing-page-container w-full min-h-screen relative overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-xl border-b border-divider-subtle">
        <div className="flex justify-between items-center px-margin-safe py-base max-w-[1728px] mx-auto">
          <div className="flex items-center gap-md cursor-pointer" onClick={() => navigate("/app")}>
            <img
              alt="HisabKitab Logo"
            ...
            />
            <span className="font-h3 text-h3 font-bold tracking-tighter text-on-surface">HisabKitab</span>
          </div>
          ...
          <div className="flex items-center gap-base">
            {authenticated ? (
              <>
                <button
                  onClick={() => navigate("/app")}
                  className="text-text-muted font-medium font-body-md text-body-md hover:text-primary transition-colors"
                >
                  Go to App
                </button>
                <button
                  onClick={handleLogout}
                  className="bg-on-surface text-surface px-md py-xs font-bold text-body-md rounded shadow-sm hover:opacity-90 transition-all"
                >
                  Logout
                </button>
              </>
      ...
      <main className="pt-32">
        {/* Hero Section */}
        <section className="px-margin-safe max-w-[1728px] mx-auto mb-32">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-xl items-start">
            <div className="lg:col-span-5 pt-xl">
              ...
              <h1 className="font-hero-headline text-hero-headline mb-lg">
                The smart <br />
                dashboard for <br />
                <span className="text-primary">your daily expenses.</span>
              </h1>
              <p className="font-body-lg text-body-lg text-text-muted mb-xl max-w-md">
              ...
              <div className="flex gap-md">
                <button
                  onClick={() => navigate("/app")}
                  className="bg-primary text-on-primary px-lg py-md font-bold text-body-md rounded-lg shadow-xl hover:translate-y-[-2px] transition-all"
                >
                  Start Tracking Now
                </button>
                <button
                  onClick={handleScrollToMockup}
                  className="border border-divider-subtle text-on-surface px-lg py-md font-bold text-body-md rounded-lg hover:bg-surface-container transition-all flex items-center gap-xs"
                >
            ...
            {/* Dashboard Mockup */}
            <div id="mockup" className="lg:col-span-7 relative">
              <div className="glass-panel rounded-xl overflow-hidden shadow-2xl inner-glow">
                ...
                {/* Mockup Content */}
                <div className="p-lg grid grid-cols-3 gap-md bg-white">
                  <div className="col-span-2 space-y-md">
                    ...
                    <div className="grid grid-cols-2 gap-md">
                      <div className="border border-divider-subtle p-md rounded">
                  ...
                  <div className="border-l border-divider-subtle pl-md space-y-md">
                    <span className="font-mono-telemetry text-mono-telemetry text-text-muted block border-b border-divider-subtle pb-xs">
                      Recent Transactions
                    </span>
              ...
              <div className="absolute -bottom-10 -left-10 glass-panel p-md rounded shadow-lg animate-bounce duration-[3000ms]">
        ...
        {/* Product Principles */}
        <section id="philosophy" className="bg-surface-container py-xl border-y border-divider-subtle mb-32">
          <div className="px-margin-safe max-w-[1728px] mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-xl">
              <div>
                ...
                <h2 className="font-h1 text-h1">Your daily money, organized.</h2>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-lg">
              <div className="p-lg border border-divider-subtle bg-white hover:border-primary transition-colors">
                <span className="font-mono-telemetry text-mono-telemetry text-text-muted mb-md block">01 / LATENCY</span>
        ...
        <section className="px-margin-safe max-w-[1728px] mx-auto mb-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-xl mb-xl">
            ...
            <div className="bg-surface-container rounded-xl p-xl flex items-center justify-center border border-divider-subtle relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-xl flex-row-reverse">
            <div className="order-2 lg:order-1 bg-surface-container rounded-xl p-xl flex items-center justify-center border border-divider-subtle">
              <div className="w-full space-y-md">
                <div className="flex gap-md">
                  <div className="flex-1 bg-white border border-divider-subtle p-md rounded">
                    <span className="font-mono-telemetry text-mono-telemetry text-text-muted block mb-xs">
                      Monthly Rent
                    </span>
                ...
                <div className="bg-white border border-divider-subtle p-md rounded">
        ...
        {/* CTA Section */}
        <section className="py-[120px] bg-white relative overflow-hidden border-y border-divider-subtle">
          <div className="absolute inset-0 z-0 opacity-5">
            <div className="w-full h-full bg-[radial-gradient(circle_at_center,#1F2BC8_0,transparent_1px)] bg-[size:24px_24px]"></div>
          </div>
          <div className="px-margin-safe max-w-[1728px] mx-auto relative z-10 text-center">
            <h2 className="font-hero-headline text-h1 md:text-hero-headline mb-lg">
      ...
      <footer className="bg-background-deep border-t border-divider-subtle w-full py-xl">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-lg px-margin-safe max-w-[1728px] mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-sm">
              ...
              <li>
                <span className="font-mono-data text-mono-data text-text-muted cursor-default">System Status: Active</span>
              </li>
              <li>
                <span className="font-mono-data text-mono-data text-text-muted cursor-default">Security: Encrypted</span>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-sm">
              <li>
                <span className="font-mono-data text-mono-data text-text-muted cursor-default">Privacy Policy</span>
              </li>
              <li>
                <span className="font-mono-data text-mono-data text-text-muted cursor-default">Terms of Service</span>
              </li>
              <li>
                <span className="font-mono-data text-mono-data text-text-muted cursor-default">Data Processing</span>
              </li>
              <li>
                <span className="font-mono-data text-mono-data text-text-muted cursor-default">Compliance</span>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-sm">
              <li>
                <span className="font-mono-data text-mono-data text-text-muted cursor-default">Help Center</span>
              </li>
              <li>
                <span className="font-mono-data text-mono-data text-text-muted cursor-default">Community</span>
              </li>
              <li>
                <span className="font-mono-data text-mono-data text-text-muted cursor-default">Contact Devs</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="mt-xl pt-lg border-t border-divider-subtle px-margin-safe max-w-[1728px] mx-auto flex flex-col md:flex-row justify-between items-center gap-md">
          <span className="font-mono-data text-mono-data text-text-muted">
            © 2024 HisabKitab Tactical Systems. All rights reserved.
          </span>
          <div className="flex items-center gap-lg">
            <span className="font-mono-telemetry text-mono-telemetry text-text-muted">SECURE NODE: ACTIVE</span>
            <span className="font-mono-telemetry text-mono-telemetry text-accent-lime">STABLE SYNC</span>
          </div>
        </div>
      </footer>
    </div>
