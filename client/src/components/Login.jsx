...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-white text-slate-900 font-sans selection:bg-[#00C58D] selection:text-white">
      {/* ===================================================================== */}
      {/* LEFT HALF: 50% Full-Screen Coral/Salmon Showcase                      */}
      {/* ===================================================================== */}
      <div className="w-full md:w-1/2 min-h-[460px] md:min-h-screen bg-[#FF735C] p-8 sm:p-12 lg:p-16 flex flex-col justify-between text-white relative overflow-hidden">
        {/* Ambient Glows */}
        ...
        <div className="relative z-10 my-auto py-8 flex flex-col items-center justify-center">
          <div className="relative w-full max-w-sm flex items-center justify-center gap-4 sm:gap-6">
            ...
            <div className="w-44 sm:w-48 bg-white text-slate-800 rounded-3xl p-3.5 shadow-2xl transform -rotate-3 hover:rotate-0 transition-transform duration-300 flex flex-col items-center">
              ...
              <div className="w-full h-36 sm:h-40 rounded-2xl bg-[#FFF6F4] flex items-center justify-center overflow-hidden mb-3">
                <LottiePlayer
              ...
              <div className="mt-2.5 text-[10px] font-semibold text-[#FF735C] bg-[#FFF2EF] px-2.5 py-0.5 rounded-full">
                100% Private
              </div>
            </div>
          ...
          <p className="mt-8 text-center text-white/95 text-sm sm:text-base font-medium max-w-sm">
            Bringing effortless clarity to your daily budgets, recurring bills, and savings.
          </p>
        </div>
      ...
      <div className="w-full md:w-1/2 min-h-screen bg-white p-8 sm:p-12 lg:p-16 flex flex-col justify-between">
        ...
        <div className="max-w-md w-full mx-auto my-auto py-6">
          {/* Title */}
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 text-center mb-8 tracking-tight">
            Log In
          </h2>
          ...
          {/* Bottom: "Don't have an account? Signup Now ." */}
